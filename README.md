...
- [ ] Зачем выносит БТ в отдельный документ?
- [ ] Про бизнес-процессы - я сомневаюсь что вы их описали потому что они нуждаются в дальнейшем проектировании, давайте подумаем, зачем мы в документе приводим описание БП? Как они связаны с бизнес требованиями?
- [ ] Почему описаны только два процесса, мы не собираемся работать с физиком? И почему у нас процесс завершается подписанием договора? Дальше есть крайне важный шаг. Бизнес процесс должен завершаться значимым бизнес результатом.
- [ ] Пользовательские истории не являются функциональными требованиями
